...
function useSound(url, _ref) {
  ...
  var HowlConstructor = react__WEBPACK_IMPORTED_MODULE_0__["default"].useRef(null);
  ...
  var _React$useState2 = react__WEBPACK_IMPORTED_MODULE_0__["default"].useState(null),
      duration = _React$useState2[0],
      setDuration = _React$useState2[1];

  var _React$useState3 = react__WEBPACK_IMPORTED_MODULE_0__["default"].useState(null),
  ...
  useOnMount(function () {
    ...
    Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(null, /*! howler */ "./node_modules/howler/dist/howler.js", 7)).then(function (mod) {
      if (!isCancelled) {
  ...
  var play = react__WEBPACK_IMPORTED_MODULE_0__["default"].useCallback(function (options) {
  ...
  var stop = react__WEBPACK_IMPORTED_MODULE_0__["default"].useCallback(function (id) {
    if (!sound) {
      return;
    }
  ...
  var pause = react__WEBPACK_IMPORTED_MODULE_0__["default"].useCallback(function (id) {
    if (!sound) {
      return;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "f1badfead38b915f3278ace65ac062d4.mp3");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _sound_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sound_button */ "./tsx/sound_button.tsx");
...
let panels = [
    {
        class: 'boop_panel',
        component: _sound_button__WEBPACK_IMPORTED_MODULE_1__["BoopPanel"]
    },
];
...
/***/ "./tsx/sound_button.tsx":
/*!******************************!*\
  !*** ./tsx/sound_button.tsx ***!
  \******************************/
/*! exports provided: BoopPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BoopPanel", function() { return BoopPanel; });
...
const boopSfx = __webpack_require__(/*! ../sounds/boop.mp3 */ "./sounds/boop.mp3");

const [play] = Object(use_sound__WEBPACK_IMPORTED_MODULE_0__["default"])(boopSfx);
class BoopPanel extends preact__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    render(props, state) {
        return Object(preact__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { onClick: play }, "Boop!");
    }
}
